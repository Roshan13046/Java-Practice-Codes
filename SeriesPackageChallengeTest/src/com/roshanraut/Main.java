    ...
    public static void main(String[] args) {
        ...
        *nSum(int n) returns the sum of all numbers from 0 to n.The first 10 numbers are:
        ...
        factorial(int n) returns the product of all numbers from 1 to n
          ...
          Create a new project and add your Series library ,then test the three methods in the
          main() method at your new project.

	     */
        Series series = new Series();
        System.out.println("Sum of first 10 num : "+ series.nSum(10));
        System.out.println("Factorial of 3 is : "+series.factorial(3));
        System.out.println("Fibonacci  3rd term is : "+series.fibonacci(40));
    }
}
